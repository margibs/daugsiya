                     ...
                     <!--   <form method="post" class="af-form-wrapper" id="signUP">  -->
                      <!--   <form action="{{ url('signup/post') }}" method="POST"> -->
                       ...
                       <form action="{{ url('signup/post') }}" class="af-form-wrapper" method="POST">
                            ...
                            <!--    <form method="post" class="af-form-wrapper" accept-charset="UTF-8" action="https://www.aweber.com/scripts/addlead.pl"  id="postSignup"> -->
                                <!--  <form method="post" id="postSignup"> -->
                              ...
                              <input type="hidden" name="redirect" value="http://susanwins.com/clubhouse/home" id="redirect_2c7e9e9eeb4cdb1c7d53c5c85b3d1e9d" />
...
<script type="text/javascript">
  $(document).on('ready', function(){
    ...
    postSignupAJAX =false;
    $('#postSignup').on('submit', function(e){
      
      _form =$(this);

      if(!_form.hasClass('done')){
        e.preventDefault();
      }
      ...
      if(!postSignupAJAX){
        ...
        postSignupAJAX = true;
          ...
          firstname = $('#awf_field-83122113-first').val();
          lastname = $('#awf_field-83122113-last').val();
          email = $('#awf_field-83122114').val();
          password = $('#awf_field-83122115').val();
          BASE_URL = '{{ url() }}';
