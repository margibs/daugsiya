...
<link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  ...
  <body>
      ...
      <li><a href="#!">Second Sidebar Link</a></li> -->
        ...
        <ul id="slide-out" class="side-nav">
          ...
          <a href="{{ url('/') }}"> <i class="ion-ios-home-outline"></i> Home </a>            
            ...
            <a href="{{ url('clubhouse/prizes') }}"> <i class="ion-ios-star-outline"></i> Prize Room </a>
    ...
    <footer>
      <ul>
        <li> <a href="{{ url('/clubhouse/home') }}" class="lightbrown"> <i class="ion-home"></i> <span> Clubhouse </span> </a> </li>
        <li> <div id="messagesMenu">  <i class="ion-chatbubbles pastelblue"></i> <span> Messages </span>
        ...
        <li> <div id="globalNotifMenu"> <i class="ion-ios-bell darkorange"></i> <span> Notification </span>
        ...
        <li> <div id="notificationMenu"> <i class="ion-android-happy lightorange"></i> <span> Request </span>
