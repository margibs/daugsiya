...
<div class="form-group">
                ...
                [
                 ...
                 @if($home_image->show_add == 0)
                                  
                    <input type="checkbox" name="show_add"  id="show_add" value="{{ $home_image->show_add}}">
                @else
                  <input type="checkbox" name="show_add"  id="show_add" value="{{ $home_image->show_add}}" checked>
               
                @endif 

                  <!--  <input type="checkbox" name="show_banner" id="show_banner" value="{{ $home_image->show_add }}" @home_image->show_add ? checked : '' > -->
								</div>
