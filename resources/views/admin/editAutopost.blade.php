                ...
                <form action="{{ url('admin/autoposts') }}/{{ $autopost->id }}/edit" method="POST" class="form-horizontal">
                	...
                	<div class="row">	
										...
										<div class="form-group">
											<h6> Category </h6> 
												<select>
													...
													<option> Best Looking Games </option>
													<option> Games With Big Wins </option>
													<option> Games Based On Categories </option>
													<option> Games Based On Bonus Rounds </option>
													<option> Games By Device </option>
													<option> Favourite Casinos For Slots </option>
													<option> Best Slots Bonus Offer </option>
													<option> Favourite Offline Casinos </option>
													<option> Celebs/Current Affairs </option>
													<option> Food/Recipes </option>
													<option> Seasonal/Daily Activity Topics </option>
													<option> Cute/Funny  </option>
												</select>
											</div>
						...
						<div class="col-xs-12 col-lg-6" style="padding: 20px 40px 20px 0">
							...
							<!-- 	<div class="form-group">
									<input type="checkbox" name="social_media[]" value="google_plus" {{ $autopost->google_plus == 1 ? 'checked' : '' }} {{ $autopost->google_plus == 2 ? 'disabled="disabled" checked' : '' }}> <i class="fa fa-google-plus"></i> Google Plus
								</div>
 -->
