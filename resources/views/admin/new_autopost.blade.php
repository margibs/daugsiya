                  ...
                  <ul>
					...
					<div class="row">	
							...
							<div class="panel">
								...
								<div class="form-group">
									...
									<select name="category">
										...
										<option value="1"> Best Looking Games </option>
										<option value="2"> Games With Big Wins </option>
										<option value="3"> Games Based On Categories </option>
										<option value="4"> Games Based On Bonus Rounds </option>
										<option value="5"> Games By Device </option>
										<option value="6"> Favourite Casinos For Slots </option>
										<option value="7"> Best Slots Bonus Offer </option>
										<option value="8"> Favourite Offline Casinos </option>
										<option value="9"> Celebs/Current Affairs </option>
										<option value="10"> Food/Recipes </option>
										<option value="11"> Seasonal/Daily Activity Topics </option>
										<option value="12"> Cute/Funny  </option>
									</select>
						...
						<div class="col-xs-12 col-lg-6" style="padding: 20px 40px 20px 0">
								...
								<!-- 	<div class="form-group">
										<input type="checkbox" name="social_media[]" value="google_plus"> <i class="fa fa-google-plus"></i> Google Plus
									</div> -->
