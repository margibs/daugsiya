                                    ...
                                    CanResetPasswordContract
{
    ...
    public function favorites(){
        ...
        return $this->belongsToMany('App\Model\Post', 'game_experiences', 'user_id', 'post_id')->where('status', 1)->where('game_experiences.type' , 2)->with('user_rating')->take(12);
    }
    
    public function played_games(){

        return $this->belongsToMany('App\Model\Post', 'game_experiences', 'user_id', 'post_id')->where('status', 1)->where('game_experiences.type' , 1)->with('user_rating')->take(12);
    }
