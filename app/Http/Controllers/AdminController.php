...
{   
    ...
    public function autoposts(){
        ...
        $autoposts = Autopost::with('post')->get();
        // dd($autoposts);
    ...
    public function new_autopost()
    {
        ...
        return view('admin.new_autopost', compact('datetime'));
    }
    ...
    public function view_editAutopost($id)
    {
        ...
        return view('admin/editAutopost', compact('autopost', 'datetime'));
    ...
    {
        $ladbrokes = CasinoBannerCountry::find(9);

        return view('admin.ladbrokes',compact('ladbrokes'));
    }
	...
	public function posts(Request $request)
	{
        ...
        if($request->get('categories') != null && $request->get('categories') != 'all')
        {
           $data['posts'] = $data['posts']
                ...
                ->select('posts.id','posts.slug','posts.title','posts.created_at','categories.name')
